...
@section('content')
    ...
    <div class="admin-container">
        <div class="admin-header">
            ...
            <p>Add a new class schedule entry</p>
        </div>
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.class-sessions.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="schedule" id="schedule" class="form-input" value="{{ old('schedule') }}" required placeholder="e.g., MWF">
                    @error('schedule')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="time" id="time" class="form-input" value="{{ old('time') }}" required placeholder="e.g., 8:00 AM - 9:30 AM">
                    @error('time')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="room" id="room" class="form-input" value="{{ old('room') }}" required placeholder="e.g., Room 201">
                    @error('room')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-textarea" placeholder="Optional description for this session">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            subjectSelect.addEventListener('change', function() {
                ...
                if (selectedOption) {
                    ...
                    if (schedule && scheduleInput && !scheduleInput.value) {
                        scheduleInput.value = schedule;
                    }
                    if (time && timeInput && !timeInput.value) {
